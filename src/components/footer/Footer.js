            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col space-y-8 lg:flex-row lg:justify-between lg:space-y-0">
                    <div className="flex justify-center lg:justify-start">
                        <img src={logoUCPblanco} alt="Logo UCP" className="h-16 sm:h-20 md:h-24 w-auto" />
                    </div>
                    
                    <div className="flex flex-col space-y-8 sm:flex-row sm:space-y-0 sm:space-x-8 lg:space-x-16">
                        ...
                        <div className="hidden sm:block w-px bg-white self-stretch mx-4"></div>
